...
const ManagerLayout = ({ children }: ManagerLayoutProps) => {
        ...
        return (
            <div className="flex h-screen items-center justify-center bg-rose-50">
                <div className="relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center font-bold text-rose-600 text-xs">M</div>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="flex h-screen bg-slate-50/50 overflow-hidden">
            ...
            {/* ─── DESKTOP SIDEBAR ─── */}
            <aside className="hidden md:flex flex-col w-64 shrink-0 h-screen sticky top-0 z-30 bg-white overflow-hidden"
                style={{
                    borderRight: "1px solid #fce7f3",
                    boxShadow: "4px 0 24px -8px rgba(244,63,94,0.08)"
                }}
            >
                {/* Subtle top pink strip */}
                ...
                >
                    ...
                    <div className="relative group w-full">
                        <div className="absolute -inset-1 rounded-2xl blur-md opacity-0 group-hover:opacity-40 transition duration-500"
                        ...
                        <div className="relative w-full flex items-center justify-center bg-rose-50/60 rounded-2xl px-4 py-3 border border-rose-100
                            group-hover:border-rose-300/60 group-hover:bg-rose-50 transition-all duration-300">
                            <Image
                    ...
                    <div className="flex items-center gap-1.5 mt-3">
                        <Warehouse className="h-3 w-3" style={{ color: "#f43f5e" }} />
